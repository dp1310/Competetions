 ...
 */
 ...
 /**
  * Problem Statement:
  * You are given an array S of N strings numbered from 0 to N-1.
  * You build string sequence Ti by the following rules:
  * T0 = S0
  * Ti = Ti-1 + reverse(Ti-1) + Si
  * Now please answer M queries: by non-negative integer x output x-th character
  * of the TN-1 in 0-based indexation. It's guaranteed that x-th character of
  * the TN-1 exists.
  * Input
  ...
  * Next N lines describe array S - one string per line. Then Mlines follow
