    ...
    public void solve(FEB15.InputReader in, PrintWriter out) {
        ...
        while(q>0) {
            ...
            if(l==r)
                ...
                if(a=='c') {
                    if(b=='h')
                        out.println(ch[l-1]-ch[r]-(c[l-1]-c[r])*h[r]);
                    else if(b=='e')
                        out.println(ce[l-1]-ce[r]-(c[l-1]-c[r])*e[r]);
                    else
                        out.println(cf[l-1]-cf[r]-(c[l-1]-c[r])*f[r]);
                } else if(a=='h') {
                    if(b=='c')
                        out.println(hc[l-1]-hc[r]-(h[l-1]-h[r])*c[r]);
                    else if(b=='e')
                        out.println(he[l-1]-he[r]-(h[l-1]-h[r])*e[r]);
                    else
                        out.println(hf[l-1]-hf[r]-(h[l-1]-h[r])*f[r]);
                } else if(a=='e') {
                    if(b=='c')
                        out.println(ec[l-1]-ec[r]-(e[l-1]-e[r])*c[r]);
                    else if(b=='h')
                        out.println(eh[l-1]-eh[r]-(e[l-1]-e[r])*h[r]);
                    else
                        out.println(ef[l-1]-ef[r]-(e[l-1]-e[r])*f[r]);
                } else {
                    if(b=='c')
                        out.println(fc[l-1]-fc[r]-(f[l-1]-f[r])*c[r]);
                    else if(b=='h')
                        out.println(fh[l-1]-fh[r]-(f[l-1]-f[r])*h[r]);
                    else
                        out.println(fe[l-1]-fe[r]-(f[l-1]-f[r])*e[r]);
                }
            }
